...
Gem::Specification.new do |s|
  ...
  s.summary = 'Modifies ActiveRecord 3.0.5 - 5.0.x with the ability to store the actual class (instead of the base class) in polymorhic _type columns when using STI'
